...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new AdminRecylerAdapter(this, viewItems);
        mRecyclerView.setAdapter(mAdapter);

        FetchIntrestedCustomerData fetchData = new FetchIntrestedCustomerData();
        fetchData.execute();
    ...
    private void addItemsFromJSONArray(JSONArray data){
        try {
            for (int i=0; i<data.length(); ++i) {
                ...
                IntrestedCustomer sample = new ObjectMapper().readValue(itemObj.toString(), IntrestedCustomer.class);
