...
import com.telme.tellme.reclyeradpaters.admin.AdminUserLoginsRecyclerAdapter;
...
public class AdminUserMyLoginsActivity extends AppCompatActivity {
    private RecyclerView mRecyclerview;
    private List<Object> viewItems = new ArrayList<>();
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager layoutManager;
    private static final String TAG = "AUMyLoginsActivity";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        try {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_user_my_logins);
        mRecyclerview =  findViewById(R.id.admin_user_mylogin_recycler_view);
        mRecyclerview.setHasFixedSize(true);

        layoutManager = new LinearLayoutManager(this);
        mRecyclerview.setLayoutManager(layoutManager);

        mAdapter = new AdminUserLoginsRecyclerAdapter(this,viewItems);
