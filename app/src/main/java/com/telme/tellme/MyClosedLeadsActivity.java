...
import com.telme.tellme.reclyeradpaters.user.UserClosedLeadsRecyclerAdapter;
...
public class MyClosedLeadsActivity extends AppCompatActivity {

    private RecyclerView mRecyclerView;
    private List<Object> viewItems = new ArrayList<>();
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager layoutManager;
    private static final String TAG = "MyClosedLeadsActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        try {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user_my_closed_leads);
        mRecyclerView = (RecyclerView) findViewById(R.id.user_myclosed_recycler_view);
        ...
        mAdapter = new UserClosedLeadsRecyclerAdapter(this, viewItems);
        mRecyclerView.setAdapter(mAdapter);

        StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
        StrictMode.setThreadPolicy(policy);
            Bundle b = getIntent().getExtras( );
           UserCustomeRestUtil.fetchData(b,"getleadsclosed",viewItems);
